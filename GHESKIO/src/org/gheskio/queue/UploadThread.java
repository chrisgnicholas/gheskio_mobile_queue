...
public class UploadThread implements Runnable {
    ...
    public static void doUpload(ProgressDialog progressDialog) {
        try {
            ...
            System.out.println("deebug: connecting to: " + uploadURL);
            url = new URL(uploadURL);

            System.out.println("deebug: 1");
            ...
            while (!isDone) {
                ...
                ++numRows;
                progressDialog.setProgress(numRows);
            ...
            System.out.println("deebug: 3 got the exception you wanted");
